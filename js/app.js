...
function mostrarAutos(autos) {
    ...
    limpiarHTML(); // Limpia HTML previo
...
// Funcions de ALTO NIVEL (HIGH ORDER FUNCTION)
...
function noResultado() {
    ...
    noResult.textContent = 'No hay coincidencia de resultados. Intente con otra búsqueda';
